...
// const ChatPage = () => {
//   const [textMessage, setTextMesssage] = useState("");
...
//               type="text"
//               value={textMessage}
//               onChange={(e) => setTextMesssage(e.target.value)}
...
const ChatPage = () => {
    ...
    const sendMessageHandler = async (receiverId) => {
        try {
            const res = await axios.post(`https://instaclone-1-11yj.onrender.com/api/v1/message/send/${receiverId}`, { textMessage }, {
                headers: {
                    'Content-Type': 'application/json'
                },
                withCredentials: true
